...
func (c *Client_t) connect(){
	...
	start := time.Now()
	synPacket := tcp.ContructTCPHeader(uint16(c.Port),uint16(serverPort),uint32(0x1000),uint32(0),uint8(5),uint8(0),tcp.TCP_SYN,uint16(0),uint16(0),uint16(0))
