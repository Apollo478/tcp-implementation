...
func Client(port int){
	...
	synPacket := tcp.ContructTCPHeader(uint16(port),uint16(8080),uint32(0x1000),uint32(0),uint8(5),uint8(0),tcp.TCP_SYN,uint16(0),uint16(0),uint16(0))
